...
RSpec.describe ContributionsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested contribution as @contribution" do
      contribution = Contribution.create! valid_attributes
      get :show, params: {id: contribution.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested contribution as @contribution" do
      contribution = Contribution.create! valid_attributes
      get :edit, params: {id: contribution.to_param}, session: valid_session
      expect(assigns(:contribution)).to eq(contribution)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Contribution" do
        expect {
          post :create, params: {contribution: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved contribution as @contribution" do
        post :create, params: {contribution: invalid_attributes}, session: valid_session
        expect(assigns(:contribution)).to be_a_new(Contribution)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested contribution" do
        contribution = Contribution.create! valid_attributes
        put :update, params: {id: contribution.to_param, contribution: new_attributes}, session: valid_session
        contribution.reload
      ...
      it "assigns the requested contribution as @contribution" do
        contribution = Contribution.create! valid_attributes
        put :update, params: {id: contribution.to_param, contribution: valid_attributes}, session: valid_session
        expect(assigns(:contribution)).to eq(contribution)
      end
    ...
    context "with invalid params" do
      it "assigns the contribution as @contribution" do
        contribution = Contribution.create! valid_attributes
        put :update, params: {id: contribution.to_param, contribution: invalid_attributes}, session: valid_session
        expect(assigns(:contribution)).to eq(contribution)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested contribution" do
      contribution = Contribution.create! valid_attributes
      expect {
        delete :destroy, params: {id: contribution.to_param}, session: valid_session
      }.to change(Contribution, :count).by(-1)
    end
