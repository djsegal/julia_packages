...
RSpec.describe NewsItemsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested news_item as @news_item" do
      news_item = NewsItem.create! valid_attributes
      get :show, params: {id: news_item.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested news_item as @news_item" do
      news_item = NewsItem.create! valid_attributes
      get :edit, params: {id: news_item.to_param}, session: valid_session
      expect(assigns(:news_item)).to eq(news_item)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new NewsItem" do
        expect {
          post :create, params: {news_item: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved news_item as @news_item" do
        post :create, params: {news_item: invalid_attributes}, session: valid_session
        expect(assigns(:news_item)).to be_a_new(NewsItem)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested news_item" do
        news_item = NewsItem.create! valid_attributes
        put :update, params: {id: news_item.to_param, news_item: new_attributes}, session: valid_session
        news_item.reload
      ...
      it "assigns the requested news_item as @news_item" do
        news_item = NewsItem.create! valid_attributes
        put :update, params: {id: news_item.to_param, news_item: valid_attributes}, session: valid_session
        expect(assigns(:news_item)).to eq(news_item)
      end
    ...
    context "with invalid params" do
      it "assigns the news_item as @news_item" do
        news_item = NewsItem.create! valid_attributes
        put :update, params: {id: news_item.to_param, news_item: invalid_attributes}, session: valid_session
        expect(assigns(:news_item)).to eq(news_item)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested news_item" do
      news_item = NewsItem.create! valid_attributes
      expect {
        delete :destroy, params: {id: news_item.to_param}, session: valid_session
      }.to change(NewsItem, :count).by(-1)
    end
