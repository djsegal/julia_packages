...
ActiveRecord::Schema.define(version: 20180420003143) do
  ...
  create_table "daters", id: :serial, force: :cascade do |t|
    t.datetime "created"
    t.datetime "updated"
    t.datetime "pushed"
    t.integer "package_id"
  ...
  create_table "dependencies", id: :serial, force: :cascade do |t|
    ...
    t.index ["depended_id"], name: "index_dependencies_on_depended_id"
    t.index ["dependent_id", "depended_id"], name: "index_dependencies_on_uniqueness", unique: true
  ...
  create_table "dummies", id: :serial, force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
